...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create($p.'channel_accounts', function (Blueprint $t): void { $t->id(); $t->string('channel', 30); $t->string('provider', 80); $t->string('name', 120); $t->string('status', 20)->default('disconnected'); $t->json('capabilities')->nullable(); $t->timestamps(); });
